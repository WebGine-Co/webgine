    ...
    <div className="py-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 py-10">
        ...
        <ProcessusCard 
          ...
          description="Nos développeurs travaillent sur la création de votre application web. Nous effectuons des tests rigoureux pour nous assurer que tout fonctionne parfaitement avant le déploiement." 
        />
        <ProcessusCard 
          number="4"
          name="Déploiement et Maintenance" 
          description="Une fois le développement terminé, nous déployons votre application web. Nous offrons également des services de maintenance pour nous assurer que tout continue de fonctionner sans problème." 
        />
      </div>
    </div>
  );
